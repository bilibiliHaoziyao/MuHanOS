...
echo "# MuHanOS custom properties"
echo "ro.muhanos.version=Beta26.9.11"
echo "ro.muhanos.base.version=12"
echo "ro.muhanos.maintainer=MuHan"
echo "ro.muhanos.display.version=MuHanOS 12 Beta26.9.11"
echo "ro.muhanos.build.date=`$DATE`"
echo "ro.muhanos.build.date.utc=`$DATE +%s`"
echo "ro.muhanos.build.type=$TARGET_BUILD_TYPE"
